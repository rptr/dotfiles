...
" Author:   rptr <dev.rptr@gmail.com>
" Credits:  Based on garden.vim by Jak Wings <jakwings@gmail.com>
...
hi Comment 		    guifg=#b2b2b2 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=22 	    ctermbg=None 	cterm=NONE
...
hi CursorLine 		guifg=#080808 	guibg=#eeeeee 	guisp=NONE	    gui=NONE 	    ctermfg=NONE 	ctermbg=230 	cterm=NONE
hi CursorLineNr 	guifg=#080808 	guibg=#eeeeee 	guisp=NONE	    gui=NONE 	    ctermfg=NONE 	ctermbg=187 	cterm=NONE
...
hi Error 		    guifg=#ffffff 	guibg=#af0000 	guisp=NONE	    gui=NONE 	    ctermfg=NONE 	ctermbg=124 	cterm=NONE
...
hi IncSearch 		guifg=#1c1c1c 	guibg=#ffffaf 	guisp=#ffffaf	gui=NONE 	    ctermfg=0 	    ctermbg=152 	cterm=NONE
hi Include 		    guifg=#875f00 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=94 	    ctermbg=NONE 	cterm=bold
...
hi LineNr 		    guifg=#e4e4e4 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=173 	ctermbg=15  	cterm=NONE
...
hi Number 		    guifg=#00005f 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=166 	ctermbg=230 	cterm=bold
...
hi PmenuThumb 		guifg=NONE 	    guibg=#afaf87 	guisp=NONE	    gui=NONE 	    ctermfg=NONE 	ctermbg=94  	cterm=NONE
hi PreCondit 		guifg=#875f00 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=94 	    ctermbg=NONE 	cterm=NONE
hi PreProc 		    guifg=#875f00 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=29 	    ctermbg=NONE 	cterm=NONE
...
hi Search 		    guifg=#444444 	guibg=#ffffd7 	guisp=#ffffd7	gui=NONE 	    ctermfg=0 	    ctermbg=152 	cterm=NONE
...
hi StatusLine 		guifg=#eeeeee 	guibg=#808080 	guisp=NONE	    gui=NONE 	    ctermfg=15 	    ctermbg=235 	cterm=NONE
hi StatusLineNC 	guifg=#c6c6c6 	guibg=#808080 	guisp=NONE	    gui=NONE 	    ctermfg=251 	ctermbg=235 	cterm=NONE
hi StorageClass 	guifg=#5f0000 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=52 	    ctermbg=NONE 	cterm=NONE
hi String 		    guifg=#00005f 	guibg=NONE 	    guisp=NONE	    gui=NONE 	    ctermfg=124 	ctermbg=NONE 	cterm=NONE
...
hi Todo 		    guifg=#ffffff 	guibg=#ffaf00 	guisp=NONE	    gui=NONE 	    ctermfg=0 	    ctermbg=227     cterm=NONE
...
hi VertSplit 		guifg=#c6c6c6 	guibg=#808080 	guisp=NONE	    gui=NONE 	    ctermfg=101 	ctermbg=101 	cterm=NONE
...
hi WildMenu 		guifg=#afd700 	guibg=#808080 	guisp=NONE	    gui=NONE 	    ctermfg=148 	ctermbg=101 	cterm=NONE
